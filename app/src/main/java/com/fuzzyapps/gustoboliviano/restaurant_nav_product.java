 ...
 */
public class restaurant_nav_product extends Fragment {
    ...
    public restaurant_nav_product() {}

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        return inflater.inflate(R.layout.restaurant_nav_product_fragment, container, false);
    }
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        getAllProductsFromRestaurant(Globals.restaurantID);
    }
